...
function handlePasswordReset(event,appContainer,token) {
  ...
  container.innerHTML = `
    ...
    <a href="https://example.com/login" class="btn btn-play" style="display: inline-block; margin-top: 1rem;">
      Go to Login
    </a>
  `;
}
    ...
    if( data['success'] == false){
      ...
      return;
        ...
        container.innerHTML = `
            ...
            <p>We've sent password reset instructions to the email associated with: ${email}</p>
            <a href="/login" class="back-to-login">Back to Login</a>
        `;
      }
}